...
$sql = "SELECT * FROM yx_accessories ORDER BY id DESC";
    ...
    <body>
        ...
        <div class="content-lg container">
            <div class="row margin-b-40">
                <div class="col-sm-6">
                    <h2>我们的产品配件</h2>
                    <p>这个模块展示我们的产品配件，如果想要查看太阳镜，<a href="products.php">请点这里</a>。</p>
                </div>
            </div>
            <!--// end row -->
                        ...
                        <div class="col-sm-4 sm-margin-b-50">
                            <div class="margin-b-20">
                                <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                                    <a href="accessories-detail.php?id=<?php echo $row["id"];?>"><img class="img-responsive" src="admin/server/upload/<?php echo $row["altImg"];?>" alt="Our Exceptional Solutions Image"></a>
                                </div>
                            </div>
                            <h3><a href="accessories-detail.php?id=<?php echo $row["id"];?>"><?php echo $row["name"];?></a></h3>
                            <p>零售价：<?php echo $row["price"];?></p>
                            <a class="link" href="accessories-detail.php?id=<?php echo $row["id"];?>">Read More</a>
                        </div>       
            <?php
                        if($i % 3 == 0){
                            echo '</div>';
